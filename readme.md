...
Automatically shorten the link's text if the text matches the URL, i.e. `<a href="https://github.com">https://github.com</a>`. If a `data-original-href` is present, it will be used when comparing the link’s text and when generating the shortened URL.
